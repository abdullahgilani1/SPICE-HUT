...
const Profile = () => {
  ...
  return (
    <div className="bg-orange-500 min-h-screen p-8 text-white font-sans">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Account Stats */}
          <div className="bg-[#3c2a1a] rounded-lg p-4 shadow-md text-sm">
            <h3 className="font-semibold mb-3">Account Stats</h3>
            <p className="flex justify-between border-b border-[#5a3f1a] py-1">
            ...
            <p className="flex justify-between py-1">
              ...
              <span className="font-semibold">{favoriteItem}</span>
            </p>
          </div>
        </div>
      </div>
